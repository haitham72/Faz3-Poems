            ...
            jsonb_build_object(
                'matched_columns', jsonb_build_array(
                    ...
                    CASE WHEN search_entities 
                        ...
                        -- Match resolved_from aliases
                        EXISTS (
                            SELECT 1 FROM jsonb_array_elements(d.entities) e
                            WHERE jsonb_typeof(e->'resolved_from') = 'array'
                              AND EXISTS (
                    ...
                    CASE WHEN search_events 
                        ...
                        WHERE normalize_arabic(ev) ILIKE '%' || q || '%'
                    ...
                    CASE WHEN search_religion 
                        ...
                        WHERE normalize_arabic(rel) ILIKE '%' || q || '%'
                    ...
                    CASE WHEN search_subjects 
                        ...
                        WHERE normalize_arabic(subj) ILIKE '%' || q || '%'
